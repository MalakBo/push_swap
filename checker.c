...
/*   Updated: 2025/02/07 18:38:43 by mac              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void read_operations(t_list **a,t_list **b)
{
    ...
    while((n = read(0,buff,BUFFER_SIZE)))
    {
        buff[n] = '\0';
...
void print_stack(t_list *stack)
{
    ...
    while (stack)
    {
        printf("(%d, idx:%d, moves:%d) -> ", stack->number, stack->index, stack->moves);
        stack = stack->next;
    }
    printf("NULL\n");
}
