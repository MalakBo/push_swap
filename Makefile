...
#    Updated: 2025/02/08 17:41:14 by mbouyi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCB = checker.c check_args.c utils.c utils2.c list.c ft_split.c initstack.c push.c reverse_rotate.c rotate.c swap.c stack.c sort_three.c
OBJB = $(SRCB:.c=.o)
